...
class SurvProb : public PDF{
 public:
    ...
    SurvProb(double delmsqr21_, double sinsqrtheta12_, double baseline_ , const std::string& name_ = "");
 ...
 private:
    ...
    void Setdelmsqrssinsqrtheta12s(const std::vector<double>& delmsqr21s_, 
                         const std::vector<double>& sinsqrtheta12s_);
};
#endif
