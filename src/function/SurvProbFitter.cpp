...
SurvProbFitter::SurvProbFitter(SurvProb* gaus, const std::vector<std::string>& delmsqr21Names_, const std::vector<std::string>& Sinsqrtheta12Names_){
...
SurvProbFitter::GetParameterCount() const{
    return fDelmsqr21sNames.size()+fSinsqrtheta12sNames.size();
}
